...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    Where date in (
	    ...
	    Where getdate() &lt;= date
            ...
            <br />
            <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" CssClass="table table-striped table-bordered" ShowFooter="True" GridLines="Vertical" CellPadding="4">
                <Columns>
                    <asp:BoundField DataField="Title_ID" HeaderText="Title_ID" ReadOnly="True" SortExpression="Title_ID" />
