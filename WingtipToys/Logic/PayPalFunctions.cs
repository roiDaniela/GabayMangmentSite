...
public class NVPAPICaller
{
  ...
  public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
  {
    ...
    using (GabayManageSite.Logic.ShoppingCartActions myCartOrders = new GabayManageSite.Logic.ShoppingCartActions())
    {
  ...
  public string HttpCall(string NvpRequest)
  {
    ...
    {
      // Log the exception.
      GabayManageSite.Logic.ExceptionUtility.LogException(e, "HttpCall in PayPalFunction.cs");
    }
