...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server" >
    <section>
        <div>
            ...
            <%--<asp:ListView ID="ListViewPrayers" runat="server" 
                DataKeyNames="PrayerID" GroupItemCount="4"
                ItemType="WingtipToys.Models.Prayer" SelectMethod="GetPrayers">
                <EmptyDataTemplate>
                    <table >
                        <tr>
                ...
                <ItemTemplate>
                    <td runat="server">
                        <table>
                            <tr>
                                <td>
                                  <a href="<%#: GetRouteUrl("PrayerByIdRoute", new {prayerId = Item.PrayerID}) %>"> 
                                    <image src='/Catalog/Images/Thumbs/boatbig.png'
            ...
            <%--<asp:ListView ID="PrayersDataList" GroupItemCount="4" runat="server" DataKeyField="Id" DataSourceID="SqlDataSource1">
                ...
                <ItemTemplate>
                    <td runat="server">
                        <table>
                            <tr>
                                <td>
                                  <a href="<%#: GetRouteUrl("PrayerByIdRoute", new {prayerId = Eval("Id")}) %>">
                                    <image src='/Catalog/Images/Thumbs/boatbig.png'
                                      width="100" height="75" border="1" />
                                  </a> 
                                </td>
