...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server" >
    <section>
        <div>
            ...
            <asp:ListView SelectMethod="GetPrayers" ID="PrayersListView" ItemType="WingtipToys.Models.Prayer" runat="server" DataKeyField="Id" GroupItemCount="4">
                 <EmptyDataTemplate>
                    <table >
                        <tr>
                ...
                <ItemTemplate>
                    <td runat="server">
                        <table>
                            <tr>
                                <td>
                                    <a href="<%#: GetRouteUrl("PrayerByIdRoute", new {prayerId =  Eval("")}) %>">
